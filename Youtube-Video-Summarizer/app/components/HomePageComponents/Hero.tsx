    ...
    return (
        <section className={`${poppins.className} relative h-screen overflow-x-hidden flex items-center justify-center text-center text-white`}>
          ...
          <div className="relative z-10 max-w-4xl px-4">
            ...
            <p className="text-base md:text-lg mb-8">Transform YouTube videos, lengthy PDFs, and complex documents into clear, engaging notes with multiple themes and language support.</p>
            <div className="flex flex-col md:flex-row space-y-4 md:space-y-0 md:space-x-4 justify-center">
              <a href="#" className="px-6 py-3 bg-black/40 hover:bg-black/60 rounded-full text-sm">Open App</a>
