...
export default function UploadComponent({ref}) {
    ...
    <div ref={ref} className="h-screen w-screen bg-black">
      {!isSummaryVisible ? (
        <div className="h-full w-full flex flex-col">
          ...
          <div className="relative flex-grow flex items-center justify-center m-8">
            <Image
              fill
              src="/hero.jpg"
              alt="Random"
        ...
        <div className="summary-section px-4 py-6 bg-black text-white h-full w-full flex flex-col justify-center items-center">
          <div className="summary-content text-center">
            ...
            invention had a decisive contribution in spread of mass-learning
            and in building the basis of the modern society. Gutenberg major
